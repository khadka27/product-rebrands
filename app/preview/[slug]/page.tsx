        ...
        <div className="relative">
          ...
          <div className="relative max-w-6xl mx-auto px-4 py-4 md:py-8">
            ...
            <div className="text-center mb-6 md:mb-12 pt-4 md:pt-8">
              ...
              <h1 className="text-xl sm:text-2xl md:text-4xl lg:text-5xl font-extrabold mb-2 md:mb-4 text-center text-[#E53E3E]">
                THIS PRODUCT HAS BEEN RENAMED TO
              </h1>
              <h2 className="text-2xl sm:text-3xl md:text-5xl lg:text-7xl font-black text-center text-[#E53E3E]">
