  ...
  return (
    <section className="mb-8 md:mb-20">
      <motion.div
        ...
        className="backdrop-blur-sm bg-[var(--card-bg)] border border-[var(--card-border)] rounded-xl md:rounded-3xl p-4 md:p-12 overflow-hidden relative shadow-lg"
      >
        {/* Glow effect */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-[var(--glow-color-blue)] rounded-full filter blur-[100px] opacity-20"></div>
