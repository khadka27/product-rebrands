  ...
  return (
    <section className="mb-8 md:mb-20">
      ...
      >
        ...
        <div className="relative backdrop-blur-sm rounded-xl md:rounded-3xl p-4 md:p-12 lg:p-16 border border-blue-500/30">
          <div className="grid md:grid-cols-2 gap-4 md:gap-8 items-center">
            <div className="max-w-xl">
              <h2 className="text-xl sm:text-2xl md:text-4xl lg:text-5xl font-bold mb-2 md:mb-6 text-white">
                {product?.name}
              </h2>

              <p className="text-sm md:text-xl mb-3 md:mb-8 text-white/95">
              ...
              >
                <Button
                  className="relative overflow-hidden group bg-gradient-to-r from-yellow-500 to-yellow-400 hover:from-yellow-600 hover:to-yellow-500 text-xs md:text-lg py-3 md:py-7 px-3 md:px-10 rounded-xl transition-all duration-300 border border-yellow-400/20 w-full sm:w-auto"
