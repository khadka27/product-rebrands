  ...
  return (
    <AnimatePresence>
      {isVisible && (
        ...
        >
          <div className="bg-[#DC2626] text-white p-4 md:p-6 rounded-lg md:rounded-xl w-[95%] mx-auto border-l-4 border-[#DC2626]">
            ...
            <p className="text-sm md:text-base lg:text-lg text-center leading-relaxed mb-4 md:mb-6">
              Due to the popularity of our product, counterfeit versions are
              being sold under our old name. To protect our customers, we have
              officially renamed our authentic formula to{" "}
              <span className="font-bold text-yellow-100">{product?.name}</span>
              . Only purchase from authorized retailers to ensure you receive
              the genuine product.
            </p>
